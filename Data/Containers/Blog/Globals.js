...
module.exports = {
  ...
  LATEST_BLOG_COUNT : 5, // here set Maximum LATEST BLOG COUNT For ** Category_Post Screen **

  SHOW_TRENDING_BLOG : true, // here set Visibility of TRENDING BLOG For ** Category_Post Screen **
  TRENDING_BLOG_COUNT : 5, // here set Maximum TRENDING BLOG COUNT For ** Category_Post Screen **

  FEATURED_TAG_ID: 11, // here set ID For FEATURED BLOG For ** Category_List Screen **
  FEATURED_BLOG_COUNT : 6, // here set Maximum FEATURED BLOG COUNT For ** Category_List Screen **
